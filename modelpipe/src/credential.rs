...
//!
//! Owns the policy a listener is configured with. It does not own the
//! comparison — the constant-time check against a live request, and the
//! cell a rotation swaps, arrive with the request edge that performs them.
